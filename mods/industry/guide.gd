...
func setup(api) -> void:
	...
	api.register_guide_page("power", {"chapter": "industry", "title": "Power", "icon": "industry:cable", "order": 0,
		"keywords": "energy fe power network cable generator battery", "blocks": [
			{"type": "text", "text": "Machines run on energy (QE). Everything touching a [b]cable[/b], or another machine, joins one network: generators feed the machines on it and batteries store what is left over."},
	...
	api.register_guide_page("generators", {"chapter": "industry", "title": "Generators and Batteries", "icon": "industry:coal_generator", "order": 1,
		"unlock": {"item": "base:iron_ore"}, "keywords": "coal generator solar panel battery fuel sun", "blocks": [
			{"type": "text", "text": "• [b]Coal Generator[/b]: makes 40 QE a second while it burns fuel: coal lasts longest, then logs, then planks.\n• [b]Solar Panel[/b]: up to 15 QE a second in daylight; it needs open sky.\n• [b]Battery[/b]: stores 20 000 QE for the night."},
	...
	api.register_guide_page("machines", {"chapter": "industry", "title": "Lamps and the Auto Miner", "icon": "industry:miner", "order": 2,
		"unlock": {"item": "base:iron_ore"}, "keywords": "lamp light miner auto dig", "blocks": [
			{"type": "text", "text": "[b]Electric Lamps[/b] light up while powered (4 QE a second each)."},
			{"type": "recipe", "output": "industry:lamp"},
			{"type": "text", "text": "The [b]Auto Miner[/b] digs straight down, 120 QE per block, and keeps what it mines. Open its panel to collect."},
