...
func setup(api) -> void:
	...
	api.register_recipe({"base:planks": 1, "base:stick": 1}, "simple_machines:guide_book", 1, {"unlock": "known", "category": "misc"})
...
func _first_steps(api) -> void:
	api.register_guide_chapter("basics", {"title": "First Steps", "icon": "simple_machines:guide_book", "order": 0,
		"description": "Surviving your first day."})
	api.register_guide_page("welcome", {"chapter": "basics", "title": "Welcome", "icon": "simple_machines:guide_book", "order": 0,
	...
	api.register_guide_page("food", {"chapter": "basics", "title": "Hunger and Food", "icon": "base:apple", "order": 4,
		"unlock": {"page": "simple_machines:wood"}, "keywords": "eat hunger starve health regenerate saturation drumstick",
		"blocks": [
...
func _crafting(api) -> void:
	...
	api.register_guide_page("experiment", {"chapter": "crafting", "title": "Experimenting", "icon": "base:torch", "order": 2,
		"unlock": {"page": "simple_machines:discovery"}, "keywords": "experiment grid arrange pattern try",
		"blocks": [
