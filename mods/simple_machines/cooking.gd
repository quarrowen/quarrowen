...
func setup(mod_api, sounds: Dictionary) -> void:
	...
	api.register_recipe({"base:cobblestone": 5, "base:iron_ingot": 1}, "simple_machines:cooking_pot", 1, {"station": "crafting_table"})
	...
	api.register_recipe({"base:planks": 3}, "simple_machines:bowl", 4, {"station": "crafting_table", "unlock": "known"})
	...
	api.register_recipe({"base:apple": 2, "base:wheat": 2, "simple_machines:bowl": 1}, "simple_machines:apple_pie", 1,
		{"station": STATION, "skill": "simple_machines:cooking", "time": 6.0, "category": "food"})
